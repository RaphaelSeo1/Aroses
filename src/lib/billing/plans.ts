 ...
 *
 * Numeric limits are NOT additive across tiers. Student gets 250 source pages
 * total — not Basic's 100 plus Student's 250.
 *
...
export const PLANS: Record<PlanTier, PlanConfig> = {
  ...
  advanced: {
    ...
    highlights: [
      ...
      "750 source pages",
      "Up to 15 PDFs per course",
      "10 hours voice tutoring",
      "25 lecture recordings",
