      ...
      <div className="flex flex-1 flex-col justify-center py-4">
        ...
        {schoolHd ? (
          <p className="mt-4 rounded-xl border border-brand-border bg-brand-blush/90 px-4 py-3 text-sm leading-relaxed text-brand-ink dark:border-brand-border/40 dark:bg-brand-blush/10 dark:text-brand-blush">
            Use your <strong className="font-semibold">school Google</strong>{" "}
            account for{" "}
            <strong className="font-semibold">{schoolHd}</strong>. You&apos;ll
            sign in on Google&apos;s page — the same kind of login your school
            uses when they&apos;re on Google Workspace.
          </p>
        ) : null}
        ...
        <div className="mt-8 space-y-6">
          <GoogleSignInButton
            nextPath={nextPath}
            label={
              schoolHd ? "Continue with school Google" : "Continue with Google"
            }
          />
          ...
          {!hideEmailPassword ? (
            ...
            <p className="text-center text-xs text-zinc-500 dark:text-zinc-400">
              ...
              {schoolHd ? " with your school account" : ""} above.
            </p>
          )}
        </div>
      </div>
