...
const en = {
  ...
  faq: {
    ...
    pricingParagraph:
      "You're not paying for access to AI — that's commoditized. You're paying for the parts that turn AI into a study routine you'll actually follow: course-structured lessons, persistent spaced repetition, progress tracking, and not having to engineer prompts. **Free** includes {freeHighlight} plus unlimited text tutoring, course building, quizzes, and SRS. **Student** is ${studentPrice}/month ({studentVoiceHours} hours of voice/month, up to 2 courses). **Premium** is ${premiumPrice}/month ({premiumVoiceHours} hours of voice/month, unlimited courses). Voice caps switch you to text — never a hard block mid-study. Optional voice top-ups are planned (~$8/hour). If you have the discipline to rebuild all of this yourself with free tools every session, you may not need us. Most people don't, and that's who Aroses is for.",
    honestItems: [
      {
        id: "vs-chatgpt",
