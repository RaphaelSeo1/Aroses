const en = {
  ...
  streakLabelMany: "day streak",
  daysToPlus: "{remaining} more to unlock Plus",
  progress: "{current}/{goal} toward Plus",
  progressLabel: "Toward Plus",
  progressCount: "{current} of {goal}",
  progressDone: "Plus month unlocked",
  progressDoneShort: "Plus unlocked",
  rewardHint: "30 consecutive days → one free month of Plus.",
  celebrationTitle: "You're here.",
  celebrationBody: "See you tomorrow.",
...
const ko: typeof en = {
  ...
  streakLabelOne: "일 연속",
  streakLabelMany: "일 연속",
  daysToPlus: "Plus까지 {remaining}일 남았어요",
  progress: "Plus까지 {current}/{goal}",
  progressLabel: "Plus까지",
  progressCount: "{current} / {goal}",
  progressDone: "Plus 한 달 잠금 해제",
  progressDoneShort: "Plus 해제",
  rewardHint: "30일 연속 → Plus 한 달.",
  celebrationTitle: "오늘도 왔군요.",
  celebrationBody: "내일 또 만나요.",
