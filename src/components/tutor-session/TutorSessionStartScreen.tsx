...
export function TutorSessionStartScreen() {
  ...
  return (
    <div className="relative overflow-hidden rounded-3xl border border-white/60 bg-white/85 p-8 shadow-xl shadow-zinc-900/[0.06] ring-1 ring-white/50 backdrop-blur-md dark:border-zinc-800 dark:bg-zinc-950/80 sm:p-12">
        ...
        <div className="mt-4">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <span className="text-[11px] text-zinc-500 dark:text-zinc-500">
              PDFs, photos, notes — purely context, never turned into a course.
            </span>
          </div>
          {files.length > 0 ? (
